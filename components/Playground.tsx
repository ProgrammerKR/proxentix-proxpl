...
import { Play, Terminal, AlertCircle, Code2, LayoutTemplate, Trash2, Copy, Check, Activity } from 'lucide-react';
                ...
                <Reveal>
                    <div className="flex flex-col items-center justify-center text-center mb-12">
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mb-8">
                            ...
                            Write code manually and see instant simulation results.
                        </p>
                        ...
                        <div className="flex flex-col h-[600px] bg-[#0d1117]">
                            <div className="flex items-center justify-between px-5 py-3 bg-[#161b22] border-b border-[#30363d]">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className={`flex items-center gap-1.5 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide border ${status === 'ready' ? 'border-slate-700 text-slate-500' :
